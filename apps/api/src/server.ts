...
async function main() {
  ...
  app.addHook("onSend", async (_req, reply) => {
    ...
    reply.header("Content-Security-Policy",
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src * data: blob:; media-src * blob:; connect-src * wss:; font-src 'self' data:; frame-ancestors 'none';"
    );
